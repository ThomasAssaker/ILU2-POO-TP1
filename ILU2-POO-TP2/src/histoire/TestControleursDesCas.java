...
//		Les ventes d'Intrus : null
		...
		// ControlPrendreEtal controlPrendreEtal = null; // Retirer cette ligne
		controlPrendreEtal = new ControlPrendreEtal(controlVerifierIdentite, village); // Initialiser controlPrendreEtal ici
